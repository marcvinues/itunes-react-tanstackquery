...
import { Podcast, ITunesTopPodcastsResponse, PodcastDetail, ITunesLookupResponse } from '~/@types/interfaces/podcast';
...
export class PodcastApiService {
  ...
  async fetchTopPodcasts(): Promise<Podcast[]> {
    ...
    const url = this.buildUrl(`/lookup?id=${podcastId}&media=podcast&entity=podcastEpisode&limit=20`);
